...
export const RELATABLE_PRODUCT_REQUEST="RELATABALE_PRODUCT_REQUEST";
export const RELATABLE_PRODUCT_SUCCESS="RELATABALE_PRODUCT_SUCCESS";
export const RELATABLE_PRODUCT_FAIL="RELATABALE_PRODUCT_FAIL";
